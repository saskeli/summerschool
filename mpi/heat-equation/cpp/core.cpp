...
void exchange(Field& field, const ParallelData parallel)
{
    ...
    MPI_Status stat;
    MPI_Sendrecv(sbuf, field.ny, MPI_DOUBLE, parallel.nup, 0, rbuf, field.ny, MPI_DOUBLE, parallel.ndown, 0, MPI_COMM_WORLD, &stat);
    

    // Send to down, receive from up
    sbuf = field.temperature.data(field.nx, 0);
    rbuf = field.temperature.data(0, 0);
    MPI_Sendrecv(sbuf, field.ny, MPI_DOUBLE, parallel.ndown, 0, rbuf, field.ny, MPI_DOUBLE, parallel.nup, 0, MPI_COMM_WORLD, &stat);
